import {
  ...
  ThreadPeerLoopExecutionLinkedPayload as ContractsThreadPeerLoopExecutionLinkedPayloadSchema,
...
export const ThreadPeerLoopExecutionLinkedPayload =
  ContractsThreadPeerLoopExecutionLinkedPayloadSchema;

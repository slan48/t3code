    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          ...
          (${ORCHESTRATION_PROJECTOR_NAMES.threadPeerLoopExecutions}, 4, '2026-04-06T00:00:07.000Z'),
    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          ...
          (${ORCHESTRATION_PROJECTOR_NAMES.threadPeerLoopExecutions}, 3, '2026-04-03T00:00:40.000Z'),
